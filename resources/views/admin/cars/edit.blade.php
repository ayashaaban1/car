@extends("admin.layouts.index",["title"=>"editcar"])
@section("content")
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{ route('admin.car.update',$car->id) }}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									@csrf
                                    @method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/admin/img/'.$car->image) }}" alt="" style="width: 300px;">
											</div>
										</div>
										@error('image')
                                        <div class="alert alert-danger">{{ $message}}</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												@foreach($cate as $k)
												<option value="{{$k->id}}" @selected($car->category_id == $k->id)>{{ $k->name}}</option>
												@endforeach
												</select>
											</div>
										</div>
